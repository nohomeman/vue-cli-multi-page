<template lang="html">
  <div class="datepick" >
    <div class="tip">投资日历</div>
    <div id="calendar"  class="calendar"></div>
    <div class="bottom">
    <ul>
        <li class="p1" style="margin-left: 20px;">结息</li>
        <li class="p2" style="margin-left: 20px;">本息</li>
        <li class="p3" style="margin-left: 20px;">还本</li>
        <!-- <li class="p4">综合</li> -->
      </ul>
    </div>
  </div>
...
function getCalendarData(year, month) {
  $('.calendar-date').find('li').each(function(e) {
  ...
  $.get('/user-getcalendar.html?date=' + date, function(data) {
    var ww = [];
  ...
  Calendar.prototype = {
    ...
    renderDOM: function() { // 渲染DOM
      ...
      var _titleStr = '<a href="#" class="title"></a>' +
        ...
        '<div class="arrow">' + '<span class="arrow-prev"><</span>' + '<span class="arrow-next">></span>' + '</div>';
    ...
    inital: function() { // 初始化
      ...
      if (this.opts.ifSwitch) {
        this.$arrow_prev.bind('click', function() {
          ...
          var year = dateObj.getDate().getFullYear();
          var dateStr = returnDateStr(dateObj.getDate());
          getCalendarData(year, dateStr.substr(4, 2));
        });
